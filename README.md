...
of the hierarchical structure into a flat list for analysing e.g. in R DataFrames.

There are alternative ways to do this:
* Using [Cerner Bunsen](https://github.com/cerner/bunsen), you can load FHIR resources as DataFrames in Spark and query 
them using Spark-SQL. The main advantage is that you can use the full set of SQL operations like JOIN, etc., but you 
have to export your entire dataset first.
