...
COPY --from=builder /fhirextinguisher/build/libs/FhirExtinguisher-1.5.1-all.jar /fhirextinguisher/FhirExtinguisher-1.5.1-all.jar

ENTRYPOINT ["java", "-jar", "FhirExtinguisher-1.5.1-all.jar"]
